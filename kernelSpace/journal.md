...
(drivers/sdmmc.c)
Реализован драйвер sd-карты. Добавлена возможность чтения/запись по секторам через NONDMA, т.е. занимая процессорное время

TODO:
- Проблема с информацией о емкости CMD9