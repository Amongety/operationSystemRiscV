...
Системные вызовы используют стандарт LINUX(https://syscalls.mebeim.net/?table=riscv/32/rv32/latest)
...
TODO:
- Реализовать базовые системные вызовы согласно стандарту LINUX(https://syscalls.mebeim.net/?table=riscv/32/rv32/latest), согласно таблице выше
